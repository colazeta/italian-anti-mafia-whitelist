...
_EXPECTED_RECONSTRUCTION_LOGICAL = 694
_EXPECTED_RECONSTRUCTION_STATUS_COUNTS = {
    "listed": 583,
    "renewal_update_in_progress": 109,
    "other_or_unknown": 2,
}
_EXPECTED_RECONSTRUCTION_IDENTIFIER_COVERAGE = 675
_EXPECTED_RECONSTRUCTION_MULTI_SECTOR_GROUPS = 277
_EXPECTED_RECONSTRUCTION_DATE_ANOMALIES = 51
